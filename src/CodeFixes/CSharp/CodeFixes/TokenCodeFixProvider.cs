                    ...
                    case CompilerDiagnosticIdentifiers.ObjectOfTypeConvertibleToTypeIsRequired:
                        {
                            ...
                            CodeAction codeAction = CodeAction.Create(
                                ...
                                cancellationToken =>
                                {
                                    ExpressionSyntax expression = typeSymbol.GetDefaultValueSyntax(context.Document.GetDefaultValueOptions());
                    ...
                    case CompilerDiagnosticIdentifiers.OptionalParametersMustAppearAfterAllRequiredParameters:
                        {
                            ...
                            CodeAction codeAction = CodeAction.Create(
                                ...
                                cancellationToken =>
                                {
                                    ExpressionSyntax defaultValue = typeSymbol.GetDefaultValueSyntax(context.Document.GetDefaultValueOptions());
