...
namespace Roslynator.VisualStudio
{
    public partial class GlobalSuppressionsOptionsPage
    {
        ...
        protected override void Fill(ICollection<BaseModel> analyzers)
        {
            ...
            analyzers.Add(new BaseModel(DiagnosticIdentifiers.UnnecessaryRelationalOperator, "Unnecessary relational operator.", !IsEnabled(DiagnosticIdentifiers.UnnecessaryRelationalOperator)));
        }
    }
}